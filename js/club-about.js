  ...
  (function about ($, document, window) {
    /*
     * Resize function.
    ...
    $.fn.videobackground.defaults = {
      ...
      $(document).ready(function() {
                ...
                $('#video_bg4').html('<div id="intro"></div>');
                
                $('#intro').videobackground({
                     
                    videoSource: [
                        ['https://player.vimeo.com/external/142768197.hd.mp4?s=2a3fd16a3c0e6f62649328809a705ced&profile_id=119', 'video/mp4'],
                        ['', 'video/webm'], 
                        ['', 'video/ogg']
                        ], 
                  
                    poster: '/_/club_img/spy_poster.jpg',
