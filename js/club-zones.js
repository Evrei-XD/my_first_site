  ...
  (function zones ($, document, window) {
    /*
     * Resize function.
    ...
    $.fn.videobackground.defaults = {
      ...
      $(document).ready(function() {
                ...
                $('#video_bg3').html('<div id="intro"></div>');
                
                $('#intro').videobackground({
                     
                    videoSource: [
                        ['https://player.vimeo.com/external/142719754.hd.mp4?s=ad89552bfb3040196aca6e601a5c8ea7&profile_id=119', 'video/mp4'],
                        ['http://topgun.ru/v2/club/paintball/vid/shootout.webm', 'video/webm'], 
                        ['http://topgun.ru/v2/club/paintball/vid/shootout.ogv', 'video/ogg']
                        ], 
                  
                    poster: '/_/club_img/zones_poster.jpg',
