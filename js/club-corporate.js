  ...
  (function corporate ($, document, window) {
    /*
     * Resize function.
    ...
    $.fn.videobackground.defaults = {
      ...
      $(document).ready(function() {
                ...
                $('#video_bg5').html('<div id="intro"></div>');
                
                $('#intro').videobackground({
                     
                    videoSource: [
                        ['https://player.vimeo.com/external/142782386.hd.mp4?s=9374a5a29ecf5441202cbc078ff34b24&profile_id=119', 'video/mp4'],
                        ['', 'video/webm'], 
                        ['', 'video/ogg']
                        ], 
                  
                    poster: '/_/club_img/radar_poster.jpg',
